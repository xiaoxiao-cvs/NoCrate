...
import { Fan, Loader2, Monitor, Thermometer } from "lucide-react";
...
import { useAsusHWData } from "@/hooks/use-asushw-data";
...
export default function FanPage() {
  ...
  if (backend === "desktop") return <DesktopFanView />;
  if (backend === "asushw") return <AsusHWView />;
  return <LaptopFanView />;
}
...
// ===========================================================================
// ASUSHW sensor view — read-only temperatures + fan RPMs
// ===========================================================================

function AsusHWView() {
  const { temps, fans, loading, error } = useAsusHWData();
